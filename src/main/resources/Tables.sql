...
INSERT INTO cart (account_id, cart_id, upc, quantity) VALUES
    (1, 1, 3080, 1), (1, 1, 3115, 3), (1, 1, 3105, 1), (1, 1, 2033, 2),
    (2, 2, 4924, 2), (2, 2, 4904, 1), (2, 2, 2405, 6), (2, 2, 4260, 1), (2, 2, 4888, 2),
    (1, 3, 3082, 1), (1, 3, 4011, 10);
